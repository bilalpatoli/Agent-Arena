...
// Captured from a real runFullDemo() run so the shapes are identical to the API.
// If POST /api/arena/demo ever fails (network, build, cold serverless), the UI
// plays this instead — the tournament story NEVER breaks in front of judges.
// ─────────────────────────────────────────────────────────────────────────────
    ...
    "agents": [
      {
        ...
        "strategy": "Move as fast as possible. Fill visible fields, hit the most prominent button, and dismiss anything in the way. Optimize for speed over caution.",
        "skills": [
          {
            "id": "fill-form",
    ...
    "rounds": [
      {
        ...
        "patch": {
          ...
          "appliedAt": "2026-06-27T19:20:02.889Z"
        }
      },
      {
        "round": 2,
